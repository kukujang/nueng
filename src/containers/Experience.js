		...
		this.setState({
			exps: [
				...
				},
				{
					...
					"desc":
						"เขียน HTML/CSS จากไฟล์กราฟฟิค (PSD, AI) ที่ได้รับจากดีไซน์เนอร์ และเพิ่ม Javascript Plugin ต่าง ๆ ที่จำเป็น เช่น jquery carousel, jquery validate และเขียน HTML5 เพิ่มลูกเล่นเข้าไปในชิ้นงาน หลังจากนั้นจึงส่งไฟล์ต่อไปให้ Backend Developer พัฒนาต่อไป - ดูแลระบบ CMS (Wordpress, Drupal, CMS พัฒนาเอง) อัปเดตเนื้อหาเว็บไซต์ของลูกค้า - เขียน HTML สำหรับอีเมล"
				},
				{
					"id": 4,
					...
					"desc":
						"เขียน HTML/CSS จากไฟล์กราฟฟิค (PSD, AI) ที่ได้รับจากดีไซน์เนอร์ และเพิ่ม Javascript Plugin ต่าง ๆ ที่จำเป็น เช่น jquery carousel, jquery validate หลังจากนั้นจึงส่งไฟล์ต่อไปให้ Backend Developer พัฒนาต่อไป - เขียน HTML สำหรับอีเมล"
				},
				{
					"id": 5,
					"company": "Netcity",
